...
QT_MOC_LITERAL(3, 15, 15), // "onNewConnection"
QT_MOC_LITERAL(4, 31, 18), // "processTextMessage"
QT_MOC_LITERAL(5, 50, 7), // "message"
QT_MOC_LITERAL(6, 58, 20), // "processBinaryMessage"
...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Server::closed)) {
                *result = 0;
                return;
            }
        }
